...
export const PROFILE_DATA: Record<ProfileType, {
  ...
  giam_can: {
    MEAL_SCHEDULE: [
      { id: 'wake_up', time: '05:30', displayTime: '5h30', name: 'Uống nước ấm', icon: '🥛', activity: 'Nước ấm sảng khoái sáng', goal: 'Khởi động tiêu hóa, duy trì hydrate', category: 'morning', options: ['300ml nước ấm', '1 lát chanh tươi pha loãng không đường'] },
      { id: 'breakfast', time: '06:30', displayTime: '6h30', name: 'Ăn sáng low-GI', icon: '🥣', activity: 'Ăn sáng lành mạnh', goal: 'Giàu protein nạc & tinh bột hấp thu chậm', category: 'morning', options: ['Yến mạch pha sữa không đường + hạt chia', '2 quả trứng luộc + 1/2 củ khoai lang nhỏ', '1 tô bún riêu ít bánh + nhiều rau nạc'] },
      { id: 'snack_morning', time: '09:30', displayTime: '9h30', name: 'Bữa phụ sáng', icon: '🍏', activity: 'Trái cây ít ngọt', goal: 'Tránh hạ đường huyết, kiềm chế thèm ăn', category: 'morning', options: ['1 quả táo xanh', '1 hũ sữa chua không đường', '1/2 quả ổi tươi'] },
      { id: 'lunch', time: '12:00', displayTime: '12h00', name: 'Ăn trưa kiểm soát calo', icon: '🥗', activity: 'Ăn trưa chính', goal: '1–1.5 chén cơm gạo lứt + đạm nạc + nhiều rau', category: 'noon', options: ['1 chén cơm gạo lứt + 150g ức gà áp chảo + rau luộc', '1 chén cơm gạo lứt + cá hấp + canh rau', 'Salad ức gà/tôm hấp sốt chanh béo nhẹ'] },
      { id: 'rest', time: '13:00', displayTime: '13h00', name: 'Nghỉ trưa', icon: '😴', activity: 'Thư giãn phục hồi', goal: 'Giảm cortisol, hỗ trợ thâm hụt mỡ', category: 'noon', options: ['Chợp mắt 15-20 phút'] },
      { id: 'snack_afternoon', time: '15:30', displayTime: '15h30', name: 'Bữa phụ chiều', icon: '🥜', activity: 'Bổ sung đạm nhẹ', goal: 'Hỗ trợ năng lượng tập chiều', category: 'afternoon', options: ['1 hũ sữa chua không đường', '5-7 hạt hạnh nhân / đậu phộng luộc', '1 hộp sữa tươi không đường'] },
      { id: 'cardio', time: '17:30', displayTime: '17h30–18h30', name: 'Chạy bộ / Pickleball đốt calo', icon: '🔥', activity: 'Tập luyện Cardio / Thể thao', goal: 'Đốt 300–500 kcal, tăng chuyển hóa', category: 'afternoon', options: ['30–45 phút Pickleball/chơi thể thao', '30 phút chạy bộ hoặc đạp xe'] },
      { id: 'dinner', time: '19:00', displayTime: '19h00', name: 'Ăn tối nạc & xơ', icon: '🌙', activity: 'Ăn tối', goal: 'Thâm hụt calo nhẹ nhàng, hạn chế tinh bột tối', category: 'evening', options: ['Salad cá ngừ / tôm hấp + rau củ luộc', '1/2 chén cơm lứt + cá kho nạc + canh rau', 'Ức gà xé phay trộn gỏi bắp cải'] },
      { id: 'pre_sleep', time: '22:00', displayTime: '22h00', name: 'Trước ngủ', icon: '🌛', activity: 'Nghỉ ngơi', goal: 'Uống nước nhẹ nếu khát, không ăn thêm', category: 'evening', options: ['1 ly nước ấm nhỏ hoặc trà hoa cúc'] }
    ],
    CHECKLIST_ITEMS: [
      { id: 'c1', text: 'Uống 1 ly nước ấm ngay khi thức dậy', time: '5h30', icon: '🥛' },
      { id: 'c2', text: 'Ăn sáng đạm nạc + tinh bột hấp thu chậm', time: '6h30', icon: '🥣' },
      { id: 'c3', text: 'Ăn phụ sáng nhẹ (táo / ổi / sữa chua KĐ)', time: '9h30', icon: '🍏' },
      { id: 'c4', text: 'Ăn trưa tối đa 1–1.5 chén cơm lứt', time: '12h00', icon: '🥗' },
      { id: 'c5', text: 'Nghỉ trưa 15-20 phút', time: '13h00', icon: '😴' },
      { id: 'c6', text: 'Uống đủ 2 - 2.5L nước lọc', time: 'Cả ngày', icon: '💧' },
      { id: 'c7', text: 'Tập Cardio / Pickleball 30-45 phút', time: '17h30', icon: '🔥' },
      { id: 'c8', text: 'Ăn tối trước 19h30, không ăn quá muộn', time: '19h00', icon: '🌙' },
      { id: 'c9', text: 'Không uống nước ngọt / trà sữa / ăn vặt ngọt', time: 'Cả ngày', icon: '🚫' },
      { id: 'c10', text: 'Ngủ trước 23h00 đủ 7-8 tiếng', time: '22h30', icon: '💤' }
    ],
    RULES: [
