...
export const PROFILE_DATA: Record<ProfileType, {
  ...
  tang_can: {
    MEAL_SCHEDULE: [
      ...
      { id: 'breakfast', time: '06:30', displayTime: '6h30–7h00', name: 'Ăn sáng chính', icon: '🍜', activity: 'Bữa sáng chính', goal: 'Bù năng lượng sáng, nền cho cả ngày', category: 'morning', options: ['Phở/bún bò/bún chả cá/mì quảng + 1 bịch Vinamilk Nguyên chất', 'Bánh mì thịt/trứng + 1 bịch Vinamilk Nguyên chất', '1–1.5 chén cơm + cá/thịt/trứng + canh + Vinamilk', 'Bánh mì + 2 trứng luộc + 1 bịch Vinamilk (khi bận)'] },
